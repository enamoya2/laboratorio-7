...
function insertarPregunta(){
	...
	xmlhttp.onreadystatechange = function(){
		document.getElementById("resp").innerHTML = '<img src="https://k31.kn3.net/taringa/2/4/5/D/6/6/Ringoh/889.gif" width="100px"/>';
...
function numPreguntas(){
	$.ajax({
		...
		type: "POST",
		beforeSend:function(){$("#numpre").html('<img src="https://k31.kn3.net/taringa/2/4/5/D/6/6/Ringoh/889.gif" width="100px"/>')},
